...
const Installation = () => {
  ...
  useEffect(() => {
    const saveLocalStorageData = JSON.parse(
  ...
  const handleRemove = (id) => {
    toast("This app is uninstalled successfully");
  ...
  return (
    <div>
      ...
      <div>
        {loading && (
          <>
            <span className="loading lg:ml-[550px] loading-bars loading-xl"></span>
          </>
        )}
        {sortedItem.map((p) => (
          <div className="flex flex-col lg:flex-row  justify-between items-center bg-white rounded-2xl shadow-2xl p-2 my-5">
            <div className="flex flex-col lg:flex-row gap-10 items-center ">
              <img
                className="bg-[#D9D9D9] p-2 shadow-2xl rounded-xl h-[100px] w-[100px]"
                src={p.image}
                alt=""
              />
              <div className="space-y-5">
                ...
                <div className="flex gap-5">
                  <p className="flex flex-col items-center font-bold">
                    <img className="h-7" src={download} alt="" /> {p.downloads}
                  </p>
                  <p className="flex flex-col items-center font-bold">
                    <img className="h-7" src={rating} alt="" /> {p.ratingAvg}
                  </p>
                  <p className="flex flex-col items-center font-bold">
                    <img className="h-7" src={review} alt="" />
                    {p.reviews} MB
                  </p>
                </div>
              </div>
